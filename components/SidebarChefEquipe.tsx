...
import { Home, Wrench, ClipboardList, Warehouse } from "lucide-react";
...
const navItems = [
  ...
  },
  {
    ...
    label: "Montage",
    href: "/chefequipe/montage",
    category: "operations",
  },
  {
    id: 3,
    icon: <ClipboardList className="w-5 h-5" />,
    label: "Rapport Montage",
    href: "/chefequipe/rapportmontage",
    category: "operations",
  },
];

const SidebarChefEquipe = ({ isOpen }: { isOpen: boolean }) => {
          ...
          >
            ...
            {isOpen && (
              <div className="hidden md:block">
                <h2 className="text-lg font-bold text-gray-900">Chef Equipe</h2>
                <p className="text-xs text-gray-500">Chef Equipe</p>
              </div>
            )}
          </div>
        </div>
