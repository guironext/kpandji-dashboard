...
type Facture = {
  ...
  userId?: string;
  bonPourAccord?: { numero: string; status?: string } | null;
};
...
export default function Page() {
  ...
  const isValide =
    currentFacture?.bonPourAccord?.status === "VALIDE_APPORT_INITIAL";
          ...
          <div id="printable-area">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex flex-col items-center justify-center ">
                ...
                >
                  {isValide ? "BON POUR ACCORD VALIDE" : "BON POUR ACCORD"}
                </h1>
                {showApportInitial && (
