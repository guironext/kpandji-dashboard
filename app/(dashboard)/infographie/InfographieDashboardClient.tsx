...
import { filterPerformanceForInfographie } from "@/lib/infographie-dashboard-utils";
...
const QUICK_LINKS = [
  {
    ...
    label: "Projets",
    description: "Plans d'action & tâches",
    icon: FolderKanban,
...
export default function InfographieDashboardClient({
  ...
  const kpiCards = [
    {
      label: "Publications terminées",
      value: performanceData.totalCount,
      sub: "Livrables archivés",
      icon: Newspaper,
    ...
    },
    {
      label: "Projets",
      value: projectsCount,
      sub: `${initialActeurs.length} infographe${initialActeurs.length !== 1 ? "s" : ""}`,
      icon: FolderKanban,
  ...
  const loadData = useCallback(async () => {
    ...
    if (!res.success) {
      ...
      setPerformanceData(filterPerformanceForInfographie(res.data));
      setError(null);
    }
    setLoading(false);
  }, []);
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f8fafc]">
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(124,58,237,0.08),transparent_28%),radial-gradient(circle_at_top_right,rgba(192,38,211,0.08),transparent_24%),linear-gradient(to_bottom,#f8fafc,#ffffff_40%,#f1f5f9)]"
        aria-hidden
      />
      <div
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(167,139,250,0.28),transparent_32%),radial-gradient(circle_at_85%_10%,rgba(232,121,249,0.24),transparent_28%),radial-gradient(circle_at_70%_80%,rgba(52,211,153,0.14),transparent_30%)]"
          aria-hidden
        />
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-2xl text-base leading-relaxed text-slate-300">
                    Pilotez vos créations visuelles, objectifs et publications depuis une vue
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col lg:items-stretch">
              <Button
                ...
                disabled={loading}
                className="rounded-2xl border-0 bg-white px-6 text-violet-950 shadow-xl shadow-black/20 hover:bg-violet-50"
              >
                {loading ? (
              ...
              >
                <Link href="/infographie/publications">
        ...
        <div className="mt-10 space-y-10 pb-12">
          ...
          <section className="space-y-5">
            <SectionHeading
              eyebrow="Navigation"
              title="Accès rapide"
              description="Les modules essentiels pour piloter votre activité infographie."
            />
            ...
            <>
              <section className="space-y-5">
                <SectionHeading
                  ...
                  action={
                    <Badge
                      variant="outline"
                      className="rounded-full border-violet-200 bg-violet-50 px-3 py-1 text-violet-700"
                    >
                ...
                <div className="grid gap-5 xl:grid-cols-12">
                  <Card className="overflow-hidden border-0 bg-white shadow-xl shadow-slate-200/50 xl:col-span-8">
                    <CardHeader className="border-b border-slate-100/80 bg-gradient-to-r from-violet-50/80 to-white pb-5">
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          ...
                          <CardDescription className="mt-1">
                            Comparaison mensuelle des contributions infographie
                          </CardDescription>
                        </div>
                        <div className="hidden rounded-2xl bg-violet-50 px-3 py-2 text-right sm:block">
                  ...
                  <div className="grid gap-5 xl:col-span-4">
                    <Card className="overflow-hidden border-0 bg-white shadow-xl shadow-slate-200/50">
                      <CardHeader className="pb-2">
                        ...
                        <CardDescription>Part des publications par infographe</CardDescription>
                      </CardHeader>
                      <CardContent>
                        {pieData.length === 0 ? (
                    ...
                    {topActeur && (
                      <div className="relative overflow-hidden rounded-[1.35rem] border border-violet-200/60 bg-gradient-to-br from-violet-50 via-fuchsia-50 to-white p-5 shadow-lg shadow-violet-100/50">
                        <div className="absolute -right-8 -top-8 h-28 w-28 rounded-full bg-violet-300/20 blur-2xl" />
                        <div className="relative">
                          <div className="flex items-center gap-2">
                            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-violet-500 text-white shadow-md">
                          ...
                          <p className="mt-4 truncate text-xl font-bold text-violet-950">
                            {topActeur.fullName}
                          </p>
                          ...
                          <div className="mt-4 h-2 overflow-hidden rounded-full bg-violet-200/60">
                            <div
              ...
              <section className="grid gap-5 lg:grid-cols-2">
                ...
                <Card className="overflow-hidden border-0 bg-white shadow-xl shadow-slate-200/50">
                  <CardHeader className="border-b border-slate-100/80 bg-gradient-to-r from-emerald-50/80 to-white">
                    ...
                    <CardDescription>
                      Évolution globale — moy. {avgPerActeur} pub./infographe
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-5 pt-6">
                    {trendAreaData.length === 0 ? (
                      <EmptyChart message="Pas encore de tendance disponible." />
                    ) : (
                      <div className="h-[280px]">
                        <ResponsiveContainer width="100%" height="100%">
                          <AreaChart data={trendAreaData} margin={{ top: 8, right: 8, left: -8, bottom: 0 }}>
                            <defs>
                              <linearGradient id="infographieTrendFill" x1="0" y1="0" x2="0" y2="1">
              ...
              {objectifsByActeur.length > 0 && (
                <section className="space-y-5">
                  <SectionHeading
                    ...
                    title="Objectifs assignés par infographe"
                            ...
                            <div className="flex items-start justify-between gap-3">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="min-w-0">
                                  ...
                                  <p className="text-xs text-slate-500">{acteur.job}</p>
                                </div>
                              </div>
                              {index === 0 && pubCount > 0 && (
              ...
              <div className="flex flex-wrap justify-center gap-4 pt-2">
                <Button
                  asChild
                  size="lg"
                  className="rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-600 px-8 shadow-lg shadow-violet-200/60 hover:from-violet-600/95 hover:to-fuchsia-600/95"
                >
                  <Link href="/infographie/publications">
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="rounded-2xl border-slate-200 px-8"
                >
                  <Link href="/infographie/documentation">
