...
import { getClientsWithFacturesGroupedByYearMonth } from "@/lib/actions/facture";
...
export default function ClientsFacturesPage() {
  ...
  const handleExportToExcel = (year: string, month: string) => {
      ...
      if (facture.FactureLigne && facture.FactureLigne.length > 0) {
        facture.FactureLigne.forEach((ligne, ligneIdx) => {
          excelData.push([
            ...
            ligneIdx === 0 ? (facture.bon_pour_acquis ? "Oui" : "Non") : "",
            ligneIdx === 0 ? (facture.hasBonDeCommande ? "Oui" : "Non") : "",
        ...
        excelData.push([
          ...
          client.status_client === "CLIENT" ? "Client" : "Prospect",
          formattedDate,
          facture.bon_pour_acquis ? "Oui" : "Non",
          facture.hasBonDeCommande ? "Oui" : "Non",
          "N/A",
          "",
          "",
          "",
    ...
    const colWidths = [
      ...
      { wch: 12 }, // Statut
      { wch: 12 }, // Date Facture
      { wch: 15 }, // Bon pour Acquis
      { wch: 15 }, // Bon de Commande
      { wch: 25 }, // Modèle
      { wch: 12 }, // Couleur
      { wch: 15 }, // Transmission
      { wch: 15 }, // Motorisation
    ...
    // Generate filename
    const filename = `Clients_Factures_${monthName}_${year}_${new Date().toISOString().split('T')[0]}.xlsx`;
  ...
  const years = Object.keys(groupedData).sort((a, b) => parseInt(a) - parseInt(b));
        ...
        <div className="container mx-auto p-6 space-y-6">
            ...
            <div className="flex flex-col gap-4 mb-6">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-4xl font-bold text-gray-900">Clients et Factures</h1>
                    <p className="text-gray-600 mt-1 text-lg">Factures avec bon pour acquis ou bon de commande</p>
                  </div>
                </div>
                <Button
                  onClick={handlePrint}
          ...
          <div id="printable-area">
            ...
            <div className="print-show hidden mb-6 pb-4 border-b-2 border-gray-300 p-3">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Clients et Factures</h1>
            ...
            {years.length === 0 ? (
              ...
              years.map((year) => {
                const months = Object.keys(groupedData[year]).sort((a, b) => parseInt(a) - parseInt(b));
                return (
                              ...
                              <Table>
                                <TableHeader>
                                  <TableRow className="bg-gradient-to-r from-gray-100 to-gray-200">
                                    ...
                                    <TableHead className="font-bold text-gray-800 text-center text-base py-2">Statut</TableHead>
                                    ...
                                    return (
                                      <React.Fragment key={`${facture.id}-${idx}`}>
                                        {facture.FactureLigne && facture.FactureLigne.length > 0 ? (
                                                ...
                                                <>
                                                  ...
                                                  >
                                                    <div className="flex flex-col gap-2 items-center">
                                                      {facture.bon_pour_acquis && (
                                                        <Badge className="bg-green-100 text-green-700 border-green-300 mb-1">
                                                          <CheckCircle2 className="h-3 w-3 mr-1" />
                                                          Bon pour Acquis
                                                        </Badge>
                                                      )}
                                                      {facture.hasBonDeCommande && (
                                          ...
                                          <TableRow>
                                            <TableCell colSpan={7} className="text-center text-gray-500 p-8">
