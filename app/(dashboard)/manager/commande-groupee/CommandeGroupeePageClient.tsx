...
const CommandeGroupeePageClient = ({
  commandesVendues,
  ...
  const availableCommandesVendues = commandesVendues.filter(
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 p-8">
      <div className="max-w-[1920px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm mt-0.5">etapeCommande = PROPOSITION, commandeFlag = VENDUE</p>
                  </div>
                </div>
                <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                  <span className="text-lg font-bold">{availableCommandesVendues.length}</span>
                </div>
              </div>
            </CardHeader>
            <CardContent className="p-6 max-h-[600px] overflow-auto">
              <div className="space-y-3">
                {availableCommandesVendues.length > 0 ? (
                  availableCommandesVendues.map((commande) => (
                    <div
                      key={commande.id}
                      ...
                      <div className={`${isCreatingGroupee ? 'ml-8' : ''}`}>
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <span className="text-xs bg-gradient-to-r from-red-500 to-red-600 text-white px-3 py-1.5 rounded-full font-medium shadow-sm">
          ...
          {/* Top Right - Commandes Disponibles */}
          <Card className="shadow-lg border-0 overflow-hidden bg-white/80 backdrop-blur-sm">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-purple-100 text-sm mt-0.5">etapeCommande = PROPOSITION, commandeFlag = DISPONIBLE</p>
                  </div>
                </div>
                <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
            ...
            <CardContent className="p-6">
              ...
              {/* List of Disponible Commandes */}
              <div className="max-h-[500px] overflow-auto space-y-3">
                {availableCommandesDisponibles.length > 0 ? (
                  availableCommandesDisponibles.map((commande) => (
                    <div
                      key={commande.id}
                      draggable={isCreatingGroupee}
                      onDragStart={(e) => handleDragStart(e, commande)}
                      className={`group relative bg-gradient-to-br from-white to-purple-50/30 border-2 ${
                    ...
                    >
                      ...
                      {!isCreatingGroupee && (
                        <Button
                          ...
                          className="absolute top-3 right-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 shadow-md"
                        >
                          <Trash2 className="mr-1 h-4 w-4" />
                          {deletingCommandeId === commande.id ? 'Suppression...' : ''}
                        </Button>
                      )}
                      <div className={`${isCreatingGroupee ? 'ml-8' : ''} ${!isCreatingGroupee ? 'pr-24' : ''}`}>
                        <div className="flex justify-between items-start mb-3">
                          <div className="flex items-center gap-2.5">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-4 shadow-lg animate-in slide-in-from-top duration-300">
            <div className="flex items-center gap-3 text-white">
              ...
              <p className="text-sm font-medium">
                Glissez les commandes depuis les listes ci-dessus vers la zone de dépôt pour créer une commande groupée
              </p>
            </div>
          </div>
        )}
        ...
        {/* Button to start creating groupee */}
        {!isCreatingGroupee && (
...
export default CommandeGroupeePageClient
