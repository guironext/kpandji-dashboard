...
async function ContratsPartenariatsContent() {
...
function ContratsPartenariatsFallback() {
  return (
...
export default function ContratsEtPartenariatsPage() {
  return (
    <Suspense fallback={<ContratsPartenariatsFallback />}>
      <ContratsPartenariatsContent />
    </Suspense>
  );
}
