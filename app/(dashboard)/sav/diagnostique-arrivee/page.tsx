      ...
      <div className="sticky top-0 z-10 -mx-2 px-2 py-3 -mt-2 mb-2 bg-gradient-to-r from-slate-50/95 via-white/95 to-slate-50/95 backdrop-blur-md border-b border-slate-200/80 rounded-xl">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <Button
            ...
            disabled={saving}
            size="lg"
            className="rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white shadow-lg shadow-amber-500/25 transition-all"
          >
            {saving ? (
            ...
            <span className="ml-2">Enregistrer le diagnostic</span>
          </Button>
        </div>
      </div>
