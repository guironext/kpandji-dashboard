...
export default function RapportRendezVousPage() {
  ...
  if (!isLoaded || loading) {
    return (
      <div className="min-h-[60vh] flex items-center justify-center p-6 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-50 via-white to-indigo-50/30">
  ...
  return (
    <div className="min-h-screen p-6 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-50 via-white to-indigo-50/30">
      {/* Header */}
      <div className="sticky top-0 z-10 -mx-6 -mt-6 px-6 pt-6 pb-4 mb-6 backdrop-blur-xl bg-white/80 border-b border-slate-200/50">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-4">
            <div className="flex size-14 shrink-0 items-center justify-center rounded-2xl bg-indigo-600 shadow-lg shadow-indigo-500/25 ring-4 ring-indigo-500/10">
          ...
          <div className="flex items-center gap-3">
            <div className="rounded-xl border border-slate-200/80 bg-white/90 px-5 py-3 text-center shadow-sm backdrop-blur-sm">
            ...
            <Button
              ...
              size="sm"
              variant="outline"
              className="gap-2 border-slate-200 hover:bg-slate-50 hover:border-indigo-200 hover:text-indigo-700"
            >
              ...
              >
                <CardContent className="p-0">
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="flex-1 p-6 lg:p-8">
                      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                        <div className="flex gap-4">
                          <div className="flex size-12 shrink-0 items-center justify-center rounded-xl bg-emerald-500 text-white shadow-md ring-2 ring-emerald-500/20">
                          ...
                          <div>
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              <Badge className="bg-emerald-500/10 text-emerald-700 border-emerald-200/80 hover:bg-emerald-500/20">
                                Effectué
                              </Badge>
                            </div>
                    ...
                    {/* Action indicator */}
                    <div className="flex items-center border-t lg:border-t-0 lg:border-l border-slate-200/80 bg-slate-50/30 px-6 py-4 lg:min-w-[160px] lg:justify-center">
                      <Button
                        onClick={() => handleRapport(rv)}
                        variant="ghost"
                        size="sm"
                        className="w-full gap-2 lg:w-auto hover:bg-indigo-50 text-indigo-600 font-medium"
                      >
