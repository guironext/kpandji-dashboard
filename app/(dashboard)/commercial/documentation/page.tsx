                    ...
                    <div className="relative flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
                      ...
                      <Button
                        ...
                        className={cn(
                          ...
                          "bg-foreground text-background hover:bg-foreground/90 dark:shadow-black/50 hidden"
                        )}
                        type="button"
                  ...
                  <div className="bg-card px-5 py-6 sm:px-8 sm:py-8">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        className="w-fit gap-2 rounded-xl border-dashed hidden"
                        type="button"
                        onClick={() => openUpload(id)}
                      >
                    ...
                    {count === 0 ? (
                      <div className="relative flex flex-col items-center justify-center overflow-hidden rounded-2xl border border-dashed border-border/70 bg-gradient-to-b from-muted/20 via-muted/10 to-transparent px-6 py-16 text-center">
                        ...
                        <Button
                          variant="secondary"
                          className="relative mt-7 gap-2 rounded-xl px-6 hidden"
                          type="button"
                          onClick={() => openUpload(id)}
                        >
                          <Upload className="size-4" />
                    ...
                    <div className="flex justify-center pb-1">
                      <Button
                        ...
                        size="lg"
                        variant="secondary"
                        className="gap-2 rounded-xl px-8 shadow-sm hidden"
                        onClick={() => openUpload(id)}
                      >
                        <Upload className="size-[18px]" />
                        Ajouter un document
