									...
									<form onSubmit={handleSubmit} className="space-y-6">
										...
										<div className="flex justify-end space-x-3 pt-4 border-t-2 border-purple-200">
											<Button
												...
												variant="outline"
												onClick={resetForm}
												className="h-12 px-6 rounded-xl border-2 border-purple-300 hover:bg-purple-50">
												Annuler
											</Button>
											<div className="relative">
												...
												<Button
													type="submit"
													className="relative h-12 px-8 font-bold bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white border-0 rounded-xl">
