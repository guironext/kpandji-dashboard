...
export async function POST(request: Request) {
  try {
    ...
    const result = await createRapportRendezVousComplet({
      ...
      presentation_gamme: body.presentation_gamme,
      essai_vehicule: body.essai_vehicule,
      negociation_commerciale: body.negociation_commerciale,
      livraison_vehicule: body.livraison_vehicule,
      service_apres_vente: body.service_apres_vente,
