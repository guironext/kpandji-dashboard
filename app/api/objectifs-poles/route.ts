...
export async function GET() {
  try {
    ...
    const data = objectifs.map((o) => ({
      ...
      objectifPoleCible: o.objectifPoleCible,
    ...
    console.error("Error fetching ObjectifPole:", error);
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { objectifPeriodId, userId: targetUserId, objectifPoleCible } = body as {
    ...
    console.error("Error creating ObjectifPole:", error);
